...
import { AccessToken, IDToken, OktaAuth, OktaAuthOptions, RefreshToken, TokenParams, UserClaims, OAuthResponseMode } from "@okta/okta-auth-js";
...
export class OktaService {
    ...
    initSecureStorage() {
        this._secureStorage = new cordova.plugins.SecureStorage(
            ...
            {
                android: {
                    packageName: "com.oktapus.first_app"
                }
            }
        );
    }
